...
export const Navigation = (props) => {
    ...
    return (
        <div className='w100 flex justify-end items-center'>
            ...
            {user && <Button className="font-ubuntu fs-14 lh-23 bold c-black  ml-2 b-default disabled flex">{email}<svg width="15" height="12" className='mt-2 ml-2 ' viewBox="0 0 21 13" fill="none" xmlns="http://www.w3.org/2000/svg"  onClick={garah}>
