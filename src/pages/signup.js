    ...
    return (
        <Layoutsignup>
            <div className='h100 flex justify-center'>
                ...
                <div>
                   <div>
                    <Forminput className='input b-gray0 h-5 w-8 disabled' placeholder="username" value="form.username" onchange={change} id="username" label="Хэрэглэгчийн нэр"/>
                 </div>
                   <div>
                    ...
                    <div>
                     <Forminput label="Нууц үг" className='input b-gray0 h-5 w-8 disabled' placeholder="password" type="password" value="form.password" onchange={change} id="password"/>
                    </div>
                <div>
                    <Forminput label="Нууц үгээ давтна уу?" className='input b-gray0 h-5 w-8 disabled' placeholder="password" type="password" value="form.password2" onchange={change} id="password2"/> 
                </div>
             </div>
                    <Button className='btn ph-4 font-ubuntu w-8 fs-20 lh-23 bold c-default h-5  b-primary disabled' onClick={signUp}>Бүртгүүлэх</Button>
                    </div>
            </div>
        </Layoutsignup>
    )
